...
function Button({ children, className = "", variant, onClick }) {
  ...
  return (
      <button onClick={onClick} className={base + (variant === "outline" ? outline : filled) + className}>
        {children}
      </button>
    );
}
      ...
      <div className="text-white min-h-screen font-sans bg-black/50">
        <header className="text-center py-0 px-4 ">
          ...
          <div className="mt-6 space-x-4 py-4">
            ...
            <Button variant="outline"   onClick={() => window.location.href = '/work.html'}>See Our Work</Button>
          </div>
        </header>
